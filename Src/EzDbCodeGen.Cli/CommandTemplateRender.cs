...
namespace Plex.CodeGen.Cli
{
    public static class CommandTemplateRender
    {
        ...
        /*
         * Example Usage - templaterender -t webapi -p "/Users/rvegajr/Downloads/Schema/Output/" -sc "Server=NSWIN10VM.local;Database=CPPE;user id=CppeUser;password=Cpp3Us3r"
